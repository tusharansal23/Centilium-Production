            ...
            <div className="container py-5">
                <div className="row g-5">
                    <div className="col-lg-3 col-md-6">
                        ...
                        <p className="mb-2 d-flex align-items-baseline"><i className="fa fa-envelope me-3"></i>immigrationconsultant@email.com</p>
                        <div className="d-flex pt-2">
                            <a className="btn btn-outline-light btn-social" href=""><i className="fab fa-twitter"></i></a>
                            <a className="btn btn-outline-light btn-social" href=""><i className="fab fa-facebook-f"></i></a>
                            <a className="btn btn-outline-light btn-social" href="https://www.youtube.com/@CentiliumImmigration"><i className="fab fa-youtube"></i></a>
                            <a className="btn btn-outline-light btn-social" href="https://www.instagram.com/centiliumimmigration"><i className="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-6">
                        ...
                        <Link className="btn btn-link text-white-50" to="./Structure">Student</Link>
